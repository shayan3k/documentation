...
<template>
  <div
    class="relative flex items-top justify-center min-h-screen bg-gray-800 sm:items-center sm:pt-0"
  >
      ...
      <div class="flex flex-col md:flex-row gap-2">
        <NuxtLink to="/html">
          <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
            <h2 class="text-2xl leading-7 font-semibold">HTML Documentation</h2>
            <p class="mt-3 text-gray-600">
              We recommend you take a look at the , whether you are new or have
        ...
        <NuxtLink to="/css">
          <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
            <h2 class="text-2xl leading-7 font-semibold">CSS Documentation</h2>
            <p class="mt-3 text-gray-600">
              We recommend you take a look at the , whether you are new or have
              previous experience with the framework.<br />
            </p>
