        ...
        },
        {
          ...
          attributes: [
            ...
            },
            {
              name: 'onload',
              description:
                'Script to be run when the document is finished loading',
              value: 'script',
            },
            {
              name: 'onmessage',
            ...
            },
            {
              name: 'onredo',
              description:
                'Script to be run when the user performs an "undo" action',
              value: 'script',
            },
            {
              name: 'onresize',
            ...
            },
            {
              name: 'onundo',
              description:
                'Script to be run when the user performs a "redo" action',
              value: 'script',
            },
            {
              name: 'onunload',
